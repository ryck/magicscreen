					...
					return (
						...
						>
							<div className="flex min-w-0 flex-1 items-center gap-4">
								<div className="flex h-8 w-12 shrink-0 items-center justify-center rounded bg-white font-bold text-shadow-black text-sm">
									{platform}
								</div>
								<div className="min-w-0 flex-1 truncate text-white">
									...
									{delay && (
										<span className="ml-2 hidden text-green-900 text-xs lg:inline">
											{delay}
										</span>
									)}
								</div>
